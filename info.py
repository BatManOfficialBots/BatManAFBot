...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002335431657').split()]  # For Multiple Id Use One Space Between Each.
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'BMcollection')
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'BatManDiscussion') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
